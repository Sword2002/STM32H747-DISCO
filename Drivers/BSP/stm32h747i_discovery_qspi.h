...
#define BSP_QSPI_AddrSize_t             MT25QL512ABB_AddressSize_t
...
typedef struct
{
  ...
  BSP_QSPI_DualFlash_t DualFlashMode;   /*!<  Flash dual mode                  */
...
#define BSP_QSPI_DUALFLASH_DISABLE   (BSP_QSPI_DualFlash_t)MT25QL512ABB_DUALFLASH_DISABLE   /* Dual flash mode disabled  */
...
#define BSP_QSPI_BLOCK_8K            MT25QL512ABB_SECTOR_4K
#define BSP_QSPI_BLOCK_64K           MT25QL512ABB_BLOCK_32K
#define BSP_QSPI_BLOCK_128K          MT25QL512ABB_BLOCK_64K

/* Definition for QSPI Address mode */
#define BSP_QSPI_ADD_3BYTE        (BSP_QSPI_AddrSize_t)MT25QL512ABB_3BYTES_SIZE /* 3 Bytes address mode */
#define BSP_QSPI_ADD_4BYTE        (BSP_QSPI_AddrSize_t)MT25QL512ABB_4BYTES_SIZE /* 4 Bytes address mode */
...
/* Size of the flash */
#define QSPI_FLASH_SIZE            29     /* Address bus width to access whole memory space */
